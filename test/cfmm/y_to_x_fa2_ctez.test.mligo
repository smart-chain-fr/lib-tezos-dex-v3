...
let () = Log.describe("[FA2-CTEZ] [Cfmm.y_to_x] test suite")
...
let test_crossing_tick =
    ...
    let () = Test.log("upperTickIndex", upperTickIndex) in 
    let () = Test.log("s_after_cfmm1.cur_tick_index.i", s_after_cfmm1.cur_tick_index.i) in 
