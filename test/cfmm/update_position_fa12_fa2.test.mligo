...
let () = Log.describe("[FA12-FA2] [Cfmm.update_position] test suite")
...
let test_success_set_and_update =
    ...
    let () = FA12_helper.assert_user_balance_in_range(tokenX.taddr, user1, 1000000n, 1n) in // TODO compute fees (1000000 - fees)
    let () = FA12_helper.assert_user_balance_in_range(tokenX.taddr, cfmm.addr, 0n, 1n) in // TODO compute fees (1000000 - fees)
