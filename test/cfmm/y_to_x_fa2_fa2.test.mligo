...
let () = Log.describe("[FA2-FA2] [Cfmm.y_to_x] test suite")
...
let test_swapping_1_within_a_single_tick_range =
    ...
    let _initial_swapReceiver_balance_x = ExtendedFA2_helper.get_user_balance(tokenX.taddr, swapReceiver) in
    let _initial_swapReceiver_balance_y = ExtendedFA2_helper.get_user_balance(tokenY.taddr, swapReceiver) in
    let _initial_swapper_balance_x = ExtendedFA2_helper.get_user_balance(tokenX.taddr, swapper) in
    ...
    let () = ExtendedFA2_helper.assert_user_balance(tokenX.taddr, swapReceiver, expected_x_received_for_100) in
    let () = ExtendedFA2_helper.assert_user_balance(tokenY.taddr, swapReceiver, 0n) in
    let () = ExtendedFA2_helper.assert_user_balance(tokenX.taddr, cfmm.addr, abs(expected_x_initial_balance_for_10000000 - expected_x_received_for_100)) in
...
let test_swapping_10_within_a_single_tick_range =
    ...
    let () = ExtendedFA2_helper.assert_user_balance(tokenX.taddr, swapReceiver, expected_x_received_for_10) in
    let () = ExtendedFA2_helper.assert_user_balance(tokenY.taddr, swapReceiver, 0n) in
    let () = ExtendedFA2_helper.assert_user_balance(tokenX.taddr, cfmm.addr, abs(expected_x_initial_balance_for_10000000 - expected_x_received_for_10)) in
    let () = ExtendedFA2_helper.assert_user_balance(tokenX.taddr, feeReceiver, 0n) in
...
let test_swapping_10000_within_a_single_tick_range =
    ...
    let () = ExtendedFA2_helper.assert_user_balance(tokenX.taddr, swapReceiver, expected_x_received_for_10000) in
    let () = ExtendedFA2_helper.assert_user_balance(tokenY.taddr, swapReceiver, 0n) in
    let () = ExtendedFA2_helper.assert_user_balance(tokenX.taddr, cfmm.addr, abs(expected_x_initial_balance_for_10000000 - expected_x_received_for_10000)) in
    let () = ExtendedFA2_helper.assert_user_balance(tokenX.taddr, feeReceiver, 0n) in
...
let test_many_small_swaps_equivalent_to_1_big_swap =
    ...
    let () = ExtendedFA2_helper.assert_user_balance(tokenX.taddr, cfmm1.addr, expected_x_initial_balance_for_10000000_cfmm1) in 
    let () = ExtendedFA2_helper.assert_user_balance(tokenX.taddr, liquidityProvider, abs(10000000 - expected_x_initial_balance_for_10000000_cfmm1)) in 
    ...
    let () = ExtendedFA2_helper.assert_user_balance(tokenX2.taddr, cfmm2.addr, expected_x_initial_balance_for_10000000_cfmm2) in 
    let () = ExtendedFA2_helper.assert_user_balance(tokenX2.taddr, liquidityProvider, abs(10000000 - expected_x_initial_balance_for_10000000_cfmm2)) in 
    ...
    let () = ExtendedFA2_helper.assert_user_balance_in_range(tokenX.taddr, swapReceiver, expected_x_received_for_100_cfmm1, swap_count) in
    let () = ExtendedFA2_helper.assert_user_balance_in_range(tokenX.taddr, cfmm1.addr, abs(expected_y_initial_balance_for_10000000_cfmm1 - expected_x_received_for_100_cfmm1), swap_count) in
    // FOR CFMM2
    let expected_x_received_for_100_cfmm2 = expectedDx_cfmm2 in // 99n
    let () = ExtendedFA2_helper.assert_user_balance(tokenX2.taddr, swapReceiver, expected_x_received_for_100_cfmm2) in
    let () = ExtendedFA2_helper.assert_user_balance(tokenX2.taddr, cfmm2.addr, abs(expected_y_initial_balance_for_10000000_cfmm2 - expected_x_received_for_100_cfmm2)) in
...
let test_fee_split = 
    ...
    let () = ExtendedFA2_helper.assert_user_balance(tokenX.taddr, feeReceiver2, 0n) in
    ()
